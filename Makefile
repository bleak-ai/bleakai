...
dev:
	...
	@cd backend && source .venv/bin/activate && uvx --refresh --from "langgraph-cli[inmem]" --with-editable . --python 3.12 langgraph dev --allow-blocking & cd ../frontend && npm run dev & wait
